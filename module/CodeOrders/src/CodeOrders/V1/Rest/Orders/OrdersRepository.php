...
class OrdersRepository
{
    ...
    public function __construct(AbstractTableGateway $tableGateway, AbstractTableGateway $orderItemTableGateway , AbstractTableGateway $usersRepository )
    {
    ...
    public  function findAll()
    {
        ...
        $ordersCollelction = new OrdersCollection($arrayAdapter);
